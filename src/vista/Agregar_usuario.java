...
public class Agregar_usuario extends javax.swing.JFrame {
    ...
    private Usuario crearUsuario() {
        nomU = cu.crearNombre1(txt_nombre.getText().toLowerCase(), txt_apellido.getText().toLowerCase());
        if (cu.verificaNomU(nomU)) {
            nomU = cu.crearNombre2(txt_nombre.getText().toLowerCase(), txt_apellido.getText().toLowerCase());
            if (cu.verificaNomU(nomU)) {
                nomU = cu.crearNombre3(txt_nombre.getText().toLowerCase(), txt_apellido.getText().toLowerCase());
                if (cu.verificaNomU(nomU)) {
                    nomU = cu.crearNombre4(txt_nombre.getText().toLowerCase(), txt_apellido.getText().toLowerCase());
                }
            }
        }

        Usuario u = new Usuario(nomU,
                cu.crearContra(txt_nombre.getText().toLowerCase(), txt_apellido.getText().toLowerCase(), txt_run.getText().toLowerCase()));
    ...
    private void initComponents() {
        ...
        CBregion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione región" }));
    ...
    private void ButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRegistrarActionPerformed
        if (validarVacios()) {
            if (validarSeleccionado()) {
                if (!cp.verificaRun(txt_run.getText() + "-" + txt_dv.getText())) {
                    if (cp.validarRun(txt_run.getText() + "-" + txt_dv.getText())) {
                        if (Integer.parseInt(txt_edad.getText()) >= 18 && Integer.parseInt(txt_edad.getText()) <= 70) {
                            cu.RegistrarUsu(crearUsuario(), ce.RegistrarEmpU(crearEmpleado(),
                                    cp.RegistrarPerU(crearPersona(), cd.RegistrarDirU(crearDireccion()))));
                            JOptionPane.showMessageDialog(null, "Se ha registrado correctamente al empleado " + txt_run.getText() + "-" + txt_dv.getText() + "\nSu nombre de usuario es: " + this.nomU);
                        } else {
                    ...
                    JOptionPane.showMessageDialog(null, "El RUN ya se encuentra en la base de datos");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Por favor haga uso de todas las cajas de datos");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Por favor rellene la información solicitada");
        }
